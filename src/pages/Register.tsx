...
export default function Register() {
  ...
  const handleRegister = (e: React.FormEvent) => {
    e.preventDefault();
    alert('Account created successfully! Welcome to the society. (Prototype Session)');
  };
        ...
        >
          ...
          <div className="space-y-2.5 text-center">
            <div className="flex items-center justify-center gap-1.5 text-gold-accent">
              ...
              <span className="font-mono text-[9px] tracking-widest font-bold uppercase">EXCLUSIVE SOCIETY</span>
            </div>
            ...
            <p className="text-zinc-400 text-xs tracking-wider uppercase">
              Join our scent circle for priority access and custom sensory design tools.
            </p>
          </div>
          ...
          <form onSubmit={handleRegister} className="space-y-5">
            <div className="space-y-2">
              <Label htmlFor="name" className="text-[10px] tracking-widest uppercase text-zinc-500 font-bold">
                FULL NAME
              </Label>
              <Input
                id="name"
          ...
          <div className="text-center text-xs tracking-wider text-zinc-400 uppercase pt-4">
            ALREADY A MEMBER?{' '}
            <Link to="/login" className="text-gold-accent font-bold hover:underline">
              SIGN IN HERE
            </Link>
          </div>
        </motion.div>
